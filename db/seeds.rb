...
Order.create!(user_id: 1, product_id: 4, dollar_amount: 15, total: 15)
Order.create!(user_id: 5, product_id: 5, dollar_amount: 40, total: 40)
Order.create!(user_id: 6, product_id: 5, gallon_amount: 10, total: 39.99)
Order.create!(user_id: 2, product_id: 4, dollar_amount: 20, total: 20)
Order.create!(user_id: 5, product_id: 5, gallon_amount: 10, total: 39.99)
Order.create!(user_id: 1, product_id: 4, gallon_amount: 5, total: 16.50)
Order.create!(user_id: 4, product_id: 4, dollar_amount: 40, total: 40)
Order.create!(user_id: 3, product_id: 6, dollar_amount: 20, total: 20)
Order.create!(user_id: 1, product_id: 4, dollar_amount: 20, total: 20)
Order.create!(user_id: 6, product_id: 6, gallon_amount: 10, total: 38.59)
Order.create!(user_id: 5, product_id: 5, gallon_amount: 15, total: 59.99)
Order.create!(user_id: 2, product_id: 5, gallon_amount: 5, total: 20)
Order.create!(user_id: 6, product_id: 4, dollar_amount: 50, total: 50)
Order.create!(user_id: 6, product_id: 5, dollar_amount: 45, total: 45)
Order.create!(user_id: 4, product_id: 4, dollar_amount: 15, total: 15)
Order.create!(user_id: 2, product_id: 5, dollar_amount: 20, total: 20)
Order.create!(user_id: 1, product_id: 4, dollar_amount: 15, total: 15)
Order.create!(user_id: 7, product_id: 5, gallon_amount: 7, total: 27.99)
